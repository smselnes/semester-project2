...
(async function () {
  try {
    ...
    document.title = `Shoemania - Edit product: ${productDetails.title}`;

    newProductId.value = productDetails.id;
    newTitleInput.value = productDetails.title;
    newPriceInput.value = productDetails.price;
    newDescriptionInput.value = productDetails.description;
    editFeaturedProduct.checked = productDetails.featured;
